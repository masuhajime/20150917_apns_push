...
class ApnsPHP_Message_Custom extends ApnsPHP_Message
{
	 ...
	 * to use for the right buttonfs title instead of "View". If the value is an
	 ...
	 * localization (which is set by the userfs language preference).
	 *
	 ...
	 * key in the applicationfs Info.plist file, or falls back to Default.png.

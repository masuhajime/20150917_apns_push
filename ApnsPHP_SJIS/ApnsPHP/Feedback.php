 ...
 * its topic. Then, after verifying that the application hasnft recently been re-registered
...
class ApnsPHP_Feedback extends ApnsPHP_Abstract
{
	 ...
	 *     the device token was recorded on the feedback service. If it hasnft,
